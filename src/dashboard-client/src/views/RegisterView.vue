    ...
    <div class="max-w-md w-full space-y-8 bg-[rgba(22,21,21,0.9)] p-8 rounded-lg shadow-md border border-[#5fbfbb]">
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-gray-300">
          Or
          <router-link to="/login" class="font-medium text-[#5fbfbb] hover:text-[#4fa9a5]">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
        <div class="rounded-md shadow-sm -space-y-px">
          <div class="mb-4">
            <label for="username" class="block text-sm font-medium text-[#5fbfbb] mb-1">Username</label>
          ...
          <div>
            <label for="confirm-password" class="block text-sm font-medium text-[#5fbfbb] mb-1">Confirm Password</label>
